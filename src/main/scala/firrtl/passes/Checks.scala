...
class CheckHighForm extends Pass with PreservesAll[Transform] {
  ...
  override def prerequisites: Set[Class[Transform]] = firrtl.stage.Forms.WorkingIR
...
class CheckTypes extends Pass with PreservesAll[Transform] {
  ...
  override def prerequisites: Set[Class[Transform]] =
    Set[Class[Transform]]( classOf[InferTypes] ) ++ firrtl.stage.Forms.WorkingIR
...
class CheckGenders extends Pass with PreservesAll[Transform] {
  ...
  override def prerequisites: Set[Class[Transform]] =
    Set[Class[Transform]]( classOf[passes.ResolveGenders] ) ++ firrtl.stage.Forms.WorkingIR
